...
# conv blocks
network.add_layer(MLX(ConvBlock(in_channels=3, out_channels=96, kernel_size=7, pool_size=2)))
network.add_layer(MLX(ConvBlock(in_channels=96, out_channels=256, kernel_size=3, pool_size=2)))
# feed forward
